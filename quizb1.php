    ...
    <div id="startScreen" class="screen">
        ...
        <div class="container">
            ...
            <p class="description" style="text-align: center; margin: 2rem 0; line-height: 1.6; color: var(--secondary);">
                ...
                <span style="color: var(--accent); font-size: 1.5rem;">PYHTON BEGINNER I</span><br>
    ...
    <script>
        ...
        async function fetchQuestions() {
            try {
                ...
                const response = await fetch('fetch_all_questions.php?level=1&difficulty=beginner');
                if (!response.ok) {
