    ...
    <div id="startScreen" class="screen">
        ...
        <div class="container">
            ...
            <p class="description" style="text-align: center; margin: 2rem 0; line-height: 1.6; color: var(--secondary);">
                ...
                <span style="color: var(--accent); font-size: 1.5rem;">PYTHON BEGINNER IV</span><br>
    ...
    <script>
        ...
        async function fetchQuestions() {
            try {
                ...
                // Fetch questions for Beginner IV (level 4, difficulty beginner)
                const response = await fetch('fetch_all_questions.php?level=4&difficulty=beginner');
                if (!response.ok) {
        ...
        function endGame(reason) {
            ...
            if (reason === 'completed') {
                ...
                nextLevelBtn.onclick = () => { window.location.href = 'nextlevel.php'; };
                // Add Home button
